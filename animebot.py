...
# Configuration
BOT_TOKEN = "7964719323:AAHzNXAcaayCcN7ODfIJTFHU7OCBUjZC5p4"  # Replace with your bot token
CHAT_ID = "-1002200580233"      # Replace with your chat ID
...
def send_to_telegram(title, image_url, summary):
    ...
    caption_parts.append(f'\n\n🌟 " Anime News by `@TheAnimeTimes_acn`" 🌟')
